  ...
  return (
    <>
      <Card className="bg-card backdrop-blur-sm relative overflow-hidden flex flex-col">
        {/* Background Gradient */}
        <div className="absolute inset-0 bg-gradient-to-br from-blue-50/50 via-indigo-50/30 to-purple-50/50 dark:from-blue-900/20 dark:via-indigo-900/20 dark:to-purple-900/20 opacity-0 transition-opacity duration-300" />
